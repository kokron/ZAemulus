...
if __name__ == '__main__':
	...
	triangle_plot('/u/ki/nkokron/notebooks/ptbias_emu/testfile.png', '/u/ki/nkokron/notebooks/ptbias_emu/lpt_components_z1.0.dat', field_arr, z_late)
